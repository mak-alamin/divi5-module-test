...
const {
  RichTextContainer,
  TextContainer, Upload, UploadContainer
    ...
    content: ({ defaultSettingsAttrs }) => (
      <React.Fragment>
        ...
        >
          ...
          <FieldContainer>
            <UploadContainer attrName="upload.innerContent"
            label="Image" />
          </FieldContainer>
...
// Register module.
addAction('divi.moduleLibrary.registerModuleLibraryStore.after', 'DIVI5.simpleQuickModule', () => {
